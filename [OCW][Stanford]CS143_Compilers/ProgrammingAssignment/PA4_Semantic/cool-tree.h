...
typedef SymbolTable<Symbol, Symbol> TypeEnvironmentEntry;
typedef SymbolTable<Symbol, std::vector<std::pair<Symbol, Symbol> > > MethodEnvironmentEntry;
typedef SymbolTable<Symbol, TypeEnvironmentEntry > TypeEnvironment;
typedef SymbolTable<Symbol, MethodEnvironmentEntry > MethodEnvironment;

class TypeGraph{
public:
  SymbolTable<Symbol, Symbol> *par_table;
  void AddType(Symbol);
  void AddEdge(Symbol, Symbol, class__class*);
  TypeGraph(list_node<Class_>*);
  bool isAncestorOfB(Symbol, Symbol);
